...
app.post("/submit", (req, res) => {
  const randomNrAdj = Math.floor((Math.random() * adj.length));
  const randomNrNoun = Math.floor((Math.random() * noun.length));
  let adjective = adj[randomNrAdj];
  let name = noun[randomNrNoun];
  let header = adjective + " " + name
