...
app.delete("/posts/:id", (req, res) => {
  const toDeleteIndex = posts.findIndex(p => p.id === parseInt(req.params.id));
  if (toDeleteIndex === -1) return res.status(404).json({message: "Post not found"})

  posts.splice(toDeleteIndex,1);
